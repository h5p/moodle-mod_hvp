...
$string['librarydirectoryerror'] = 'Library directory name must match machineName or machineName-majorVersion.minorVersion (from library.json). (Directory: %directoryName , machineName: %machineName, majorVersion: %majorVersion, minorVersion: %minorVersion)';
...
$string['invalidlibraryname'] = 'Invalid library name: %name';
$string['missinglibraryjson'] = 'Could not find library.json file with valid json format for library %name';
$string['invalidsemanticsjson'] = 'Invalid semantics.json file has been included in the library %name';
$string['invalidlanguagefile'] = 'Invalid language file %file in library %library';
$string['invalidlanguagefile2'] = 'Invalid language file %languageFile has been included in the library %name';
$string['missinglibraryfile'] = 'The file "%file" is missing from library: "%name"';
$string['missingcoreversion'] = 'The library "%libraryName" requires H5P %requiredVersion, but only H5P %coreApi is installed.';
$string['invalidlibrarydataboolean'] = "Invalid data provided for %property in %library. Boolean expected.";
$string['invalidlibrarydata'] = "Invalid data provided for %property in %library";
$string['invalidlibraryproperty'] = "Can't read the property %property in %library";
$string['missinglibraryproperty'] = 'The required property %property is missing from %library';
$string['invalidlibraryoption'] = 'Illegal option %option in %library';
$string['addedandupdatelibraries'] = 'Added %new new H5P libraries and updated %old old.';
$string['addednewlibraries'] = 'Added %new new H5P libraries.';
$string['updatedlibraries'] = 'Updated %old H5P libraries.';
$string['missingdependency'] = 'Missing dependency @dep required by @lib.';
$string['invalidstring'] = 'Provided string is not valid according to regexp in semantics. (value: \"%value\", regexp: \"%regexp\")';
$string['invalidfile'] = 'File "%filename" not allowed. Only files with the following extensions are allowed: %files-allowed.';
